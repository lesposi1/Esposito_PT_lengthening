...
/*
  ...
  slides.trial = slide({
    ...
    ["not flamboyant", "flamboyant"], ["not intelligent", "intelligent"], ["not friendly", "friendly"],
    ["not educated", "educated"], ["not sincere", "sincere"]]);
...
function makeStim(stim) {
  ...
  var speaker = _.shuffle(["Brandon", "CJ", "Lewis", "Scott"])[0];
